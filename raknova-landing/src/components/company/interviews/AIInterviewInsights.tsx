import { interviewInsights } from "@/data/company/interviews";

export function AIInterviewInsights() {
  return (
    <div className="bg-white rounded-xl border border-gray-100 p-6">
      <h2 className="text-lg font-semibold text-gray-900 mb-4">AI Interview Insights</h2>
      <div className="space-y-4">
        {interviewInsights.map((insight, idx) => (
