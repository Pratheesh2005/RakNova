...
import { todayPriorities } from "@/data/company/dashboard";
...
export function TodayPriorities() {
  return (
    <div>
      <h2 className="text-lg font-semibold text-gray-900 mb-4">Today's Hiring Priorities</h2>
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        {todayPriorities.map((task) => (
          ...
          >
            ...
            <div className="mt-4">
              <Button variant="primary" size="sm" href={task.actionUrl}>
                {task.actionLabel}
              </Button>
            </div>
          </div>
