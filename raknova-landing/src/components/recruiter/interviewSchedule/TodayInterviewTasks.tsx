...
import { todayInterviewTasks } from "@/data/recruiter/interviewSchedule";
...
export function TodayInterviewTasks() {
  return (
    <div>
      <h2 className="text-lg font-semibold text-gray-900 mb-4">Today's Interview Tasks</h2>
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        {todayInterviewTasks.map((task, idx) => (
