...
export function EmptyInterviewState() {
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-16 text-center">
      ...
      <p className="text-sm text-gray-500 mt-2">Schedule an interview from Candidate Review.</p>
      <Link href="/recruiter/candidates">
        <Button variant="primary" size="md" className="mt-5">Return to Candidate Review</Button>
      </Link>
    </div>
  );
}
