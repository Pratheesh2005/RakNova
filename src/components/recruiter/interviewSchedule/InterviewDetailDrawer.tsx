        ...
        >
          ...
          <div className="p-6 space-y-6">
            <div className="flex flex-wrap gap-2">
              ...
              <span className="text-sm text-gray-500">{interview.interviewRound} Interview</span>
            </div>

            <div className="grid grid-cols-2 gap-4">
              {[
                { label: "Applied Role", value: interview.appliedRole },
                { label: "Date", value: interview.date },
                { label: "Time", value: interview.time },
                { label: "Duration", value: interview.duration },
                { label: "Mode", value: interview.interviewMode },
            ...
            <div className="space-y-2">
              ...
              {interview.portfolio && <a href={interview.portfolio} target="_blank" rel="noopener noreferrer" className="block text-sm text-blue-600 hover:underline">Portfolio</a>}
              {interview.github && <a href={interview.github} target="_blank" rel="noopener noreferrer" className="block text-sm text-blue-600 hover:underline">GitHub</a>}
              {interview.linkedin && <a href={interview.linkedin} target="_blank" rel="noopener noreferrer" className="block text-sm text-blue-600 hover:underline">LinkedIn</a>}
            </div>
            ...
            <div className="flex flex-wrap gap-2 pt-4 border-t border-gray-100">
              <Button variant="primary" size="sm">Open Candidate Review</Button>
